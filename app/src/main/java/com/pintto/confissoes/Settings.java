...
public class Settings extends AppCompatActivity {
    ...
    private Button buttonMudarSenha;
    ...
    public void tamanhoFonte(View view){ //Metodo iniciado pelo botão de Tamanho da Fonte
        ...
        String[] singleItems = {getString(R.string.item_fonte_pequena), getString(R.string.item_fonte_normal) , getString(R.string.item_fonte_grande)};
    ...
    public void modoNoturno(View view){ //Inicia o AlertDialog do Modo Noturno pelo Botao
        MaterialAlertDialogBuilder alert = new MaterialAlertDialogBuilder(this);
        String[] singleItems = {getString(R.string.item_tema_sistema), getString(R.string.item_tema_claro), getString(R.string.item_tema_escuro)};
